...
@app.post("/process")
async def process_pdf(file: UploadFile = File(...), query: Optional[str] = None):
    """
    ...
    # Usar consulta padrão se não for fornecida
    if query is None:
        query = "Extraia o texto completo deste PDF usando OCR"
