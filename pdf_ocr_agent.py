...
class PDFOCRAgent:
    ...
    def process_pdf(self, pdf_path, query="Extraia o texto completo deste PDF usando OCR"):
        """
        ...
        message = f"Use a ferramenta ler_pdf_ocr para {query} no arquivo '{pdf_path}'."
...
if __name__ == "__main__":
    agent = PDFOCRAgent()
    result = agent.process_pdf("./Requisitos.pdf")
